...
#define STRING_CONFIG_H_AUTHOR "(dahuafschmied, Anycubic i3 Mega)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_ANYCUBIC_MEGA
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "da GU-GU is"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "9d8875c0-b6da-43a3-a9c3-77fe5d452fc4"
...
#define LCD_BED_LEVELING
  ...
  #define MBL_Z_STEP 0.0025    // Step size while manually probing Z axis.
